...
class UnivsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create univ" do
    assert_difference("Univ.count") do
      post univs_url, params: { univ: { address: @univ.address, city: @univ.city, country: @univ.country, name: @univ.name, website: @univ.website } }
    end
  ...
  test "should update univ" do
    patch univ_url(@univ), params: { univ: { address: @univ.address, city: @univ.city, country: @univ.country, name: @univ.name, website: @univ.website } }
